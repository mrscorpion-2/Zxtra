...
const TELEGRAM_URL = 'https://t.me/mrzxtra';
const WHATSAPP_URL = 'https://whatsapp.com/channel/0029VbDK7drI1rcoEQNE1K3S';
...
<title>RIPPER X-MD— Whatsapp Pairing</title>
<style>
...
<div class="footer">Powered by <strong>LWAZI DEV</strong> · Keep your pairing code private.</div>
</section>
</main>

<div class="drawer" id="drawer">
<aside class="panel">
<div class="panel-head"><h3>RIPPER X-MD Menu</h3><button class="icon-btn" id="closeMenu" aria-label="Close menu">${icon('x')}</button></div>
